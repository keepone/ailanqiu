...
@Component
public class GetCBANewsFromTencent {
	...
	public static void main(String[] args) {
		getCBANews("http://sports.qq.com/l/cba/CBAlist.htm");
		//getNewsDetail("http://sports.qq.com/a/20141028/058599.htm");

	}

	public static void getCBANews(String startURL) {
		...
		try {
			...
			for(Element li:lis){
				...
				if(c==0){
					...
					content=content.replace("(微博)", "");
					Object[] params={name,content,System.currentTimeMillis(),"腾讯","02","0201",detailHref,1,sourceImg,sourceImg};
					baseDao.insertBy(sql, params);
					count = count + 1;
					System.out.println(name);
				}else{
					System.out.println(name+"－－－已经录入(CBA)");
					//break;
				}
			}
