...
<html>
  ...
  <body>
  <form action="download/AddWeiXinAction" name="myFrm" method="post">
   TYPE：<select name="fileType" width="100px">
  	<option name=".gif" value="nba" >NBA</option>
  	<option name=".gif" value="people" >民间</option>
  </select>
