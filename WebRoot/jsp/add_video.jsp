...
<html>
  ...
  <body>
  <form action="news/AddVideoDetail" name="myFrm" method="post">
  视频类型：<select name="videoType" width="100px">
  	<option name="nba" value="nba" >NBA</option>
  	<option name="teach" value="teach">教学</option>
  </select>
 
  <input type="text" id="source_url" name="source_url" style="width: 300px;height:30px;"/><br/><br/>
  <input type="submit" value="插入视频" />
