...
<script type="text/javascript" src="/msite/scripts/jquery.min.js"></script>
	...
	<body>
		...
		<ul class="titles">
			<c:forEach items="${arr}" var="json" varStatus="i">
				<li>
					<a href="/tacticsapp/TacticsDetailForApp?tacticsId=${json.id}" data-gaevent="home_post_list:home"> <span
						class="title-detail">
							<h4>
								${json.name} 
							</h4>
							</span> </a>
							<a href="/tacticsapp/UpdateTacticsAction?tacticsId=${json.id}">编辑</a>
				</li>
			</c:forEach>
			
					<a href="#" class="gotop-btn"
			data-gaevent="mobile_footer_toTop:footer"> <span class="icon-up"></span>加载更多
		</a>
		</ul>
